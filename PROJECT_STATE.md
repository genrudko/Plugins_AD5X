...
**Статус:** архитектура зафиксирована, разработка нового каркаса ещё не начата  
...
## 5. Следующая активная задача

### Platform Foundation: Fluidd integration discovery
...
5. проверить текущее состояние указанных GitHub-веток;
6. не полагаться на старые чаты, если репозиторий говорит другое;
7. при расхождении документации с кодом сначала зафиксировать расхождение, а не молча «исправлять» историю.
