...
# Prove that the standalone pycairo extension can create and paint a surface.
...
def on_press(_widget, event):
    ...
    root.override_background_color(Gtk.StateFlags.NORMAL, Gdk.RGBA(0.12, 0.38, 0.26, 1.0))
    return True
