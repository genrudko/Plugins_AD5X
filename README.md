...
- **[ROADMAP.md](ROADMAP.md)** — цель проекта, UX-принципы и порядок разработки;
- **[ARCHITECTURE.md](ARCHITECTURE.md)** — архитектурные границы, слои, frontend/backend и module contract;
- **[PROJECT_STATE.md](PROJECT_STATE.md)** — текущее состояние, активная задача и открытые вопросы;
- **[DECISIONS.md](DECISIONS.md)** — журнал принятых архитектурных решений.

> Для продолжения проекта в новом чате или новым координатором сначала прочитать эти четыре файла. Источник истины — GitHub, а не история чата.
