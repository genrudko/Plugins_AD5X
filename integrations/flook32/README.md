...
Run `integrations/flook32/install.sh` from the persistent `Plugins_AD5X`
checkout. It backs up the currently working FLOOK32 files, installs the new
module/config/ensure script, and registers an idempotent `power_on.sh` hook.
